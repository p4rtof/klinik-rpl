  ...
  return (
    <div className="w-full space-y-6 text-black">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="p-8 space-y-8">
          {/* TINDAKAN + DIAGNOSIS */}
          ...
          <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-sm overflow-hidden animate-fade-in">
            <div className="p-8 flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 font-medium mb-6">
                Apakah Anda yakin ingin menyimpan Rekam Medis ini? Pastikan seluruh data telah terisi dengan benar.
              </p>
              ...
              <div className="flex gap-3 w-full">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="flex-1 bg-primary text-white py-3 rounded-xl font-bold hover:bg-blue-600 transition-colors active:scale-95 disabled:opacity-50"
                >
                  {isSubmitting ? "Proses..." : "Ya, Simpan"}
                </button>
              </div>
            </div>
          </div>
