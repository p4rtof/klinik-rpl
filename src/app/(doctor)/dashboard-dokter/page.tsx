  ...
  return (
    <div className="w-full space-y-6 text-black">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-2">
        ...
        <div className="bg-white p-6 border shadow-sm border-gray-100 rounded-[32px] space-y-4">
        ...
        <div className="bg-white p-6 border shadow-sm border-gray-100 rounded-[32px] space-y-4 flex flex-col justify-between">
          <div>
          ...
          {isLoading ? (
            ...
            <div className="flex items-center justify-between bg-gray-50 p-4 rounded-2xl">
              <div>
                <p className="text-lg font-bold capitalize">{pasienSaatIni.pasien?.nama}</p>
        ...
        <table className="w-full">
          <thead className="bg-primary  text-white uppercase text-lg font-black ">
            <tr>
              ...
              <th className="px-2 py-3 text-center w-[15%]">Jenis Kelamin</th>
              <th className="px-2 py-3 text-center w-[15%]">Usia</th>
              <th className="px-2 py-3 text-left">Keluhan</th>
            ...
            {isLoading ? (
              ...
              antreanList.map((item: any) => (
                <tr key={item.id} className="hover:bg-gray-50/30  transition-colors">
                  ...
                  <td className="">
                    <p className="text-lg px-2 text-black capitalize my-4">{item.pasien?.nama}</p>
                  ...
                  <td className="text-left my-3 pl-2">
                      {item.keluhan}
                  </td>
                  <td className=" text-center my-3">
                    <span
                      className={`px-4 py-1.5 rounded-full text-md uppercase font-black ${
              ...
              <tr>
                <td colSpan={6} className="p-10 text-gray-400 text-center italic">
...
// Tambahkan prop titleColor
function StatCard({ title, value, icon, color, textColor, titleColor, isLoading }: any) {
  return (
    <div className="flex-1 bg-white p-4 rounded-2xl border border-gray-50 flex items-center gap-4">
      ...
      <div>
        {/* Gunakan titleColor agar warnanya bisa dinamis (merah/hijau) */}
