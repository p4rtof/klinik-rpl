...
export default function DashboardPage() {
  ...
  // 3. Gunakan useEffect untuk mengecek login saat halaman pertama kali dimuat
  // useEffect(() => {
  //   // --- SIMULASI CEK LOGIN ---
  //   // Nanti ini disesuaikan dengan cara Adit menyimpan sesi login (misal: localStorage, Cookies, atau Context)
  //   // Contoh di bawah ini mengecek apakah ada "admin_token" di localStorage
  ...
  //     router.push("/login");
  //   } else {
  //     // Jika ada token (sudah login), hentikan loading dan izinkan masuk
  //     setIsCheckingAuth(false);
  //   }
  // }, [router]);

  // // 4. Cegah dashboard "ngintip" sesaat sebelum dialihkan dengan menampilkan layar loading
  // if (isCheckingAuth) {
  //   return (
  //     <div className="flex h-screen items-center justify-center bg-gray-50">
  //       <p className="text-xl font-bold text-primary animate-pulse">Memeriksa Akses...</p>
  //     </div>
  //   );
  // }
